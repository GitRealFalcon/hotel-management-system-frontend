...
const BookingDetails = ({ booking, showBooking, onClose }) => {
    ...
    return (
        <div className={`min-h-screen w-full backdrop-blur-sm bg-opacity-0 from-gray-400 flex items-center justify-center absolute`}>
            <div className=' h-[90%] third:h-[60%] w-[90%] third:w-[70%] second:w-[60%] dark:bg-[var(--bg-secondry)] bg-[#FFFFFF] flex flex-col justify-around p-6 rounded-xl dark:border-none border border-slate-300'>
                ...
                <div className='w-full  flex gap-2 justify-between p-2 py-5 text-sm'>

                    <div className='flex w-1/2 third:flex-row flex-col gap-10'>
                        <div className='third:w-1/2 flex flex-col gap-10  '>
                            <div >
                            ...
                            <div>
                                ...
                                <div className='font-semibold dark:text-[var(--text-primary)] overflow-clip text-[#1A202C]'>{user?.email ? user.email : "N/A"}</div>
                            </div>
                            <div>
                    ...
                    <div  className='flex w-1/2 third:flex-row flex-col gap-10 overflow-hidden'>
                        ...
                        <div className='third:w-1/2  flex flex-col gap-10'>
                            ...
                            {isPayed && <div>
                                ...
                                <div className='font-semibold dark:text-[var(--text-primary)] overflow-clip text-[#1A202C]'>{isPayed && booking.payment.paymentId}</div>
                            </div>}
                        </div>
                        ...
                        <div className='third:w-1/2 flex flex-col gap-10'>
                            ...
                            <div>
                                ...
                                <div className='font-semibold dark:text-[var(--text-primary)] overflow-clip text-[#1A202C]'>{booking?._id ? booking._id : "N/A"}</div>
                            </div>
                            <div>
