...
const ImageCollage = () => {
  return (
    <div className='h-[500px] fifth:flex-row flex-col flex mt-2 gap-2 transform transition-all duration-300 rounded-xl overflow-hidden'>
      <div className='h-full hidden third:block transform transition-all duration-300 w-[50%]'>
      ...
      <div className='fifth:h-full h-1/2 fifth:w-1/2 third:w-[25%] flex flex-col gap-2 transform transition-all duration-300'>
        <div className='h-1/2 hidden fifth:block third:w-full transform transition-all duration-300'  >
        ...
        <div className='fifth:h-1/2 h-full third:w-full transform transition-all duration-300'>
