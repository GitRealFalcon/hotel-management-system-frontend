...
const DashboarSidebar = () => {
    return (
        <div className='w-[20%] h-screen dark:bg-[var(--bg-secondry)] bg-[#FFFFFF] sticky top-0 p-4'>
            ...
            <div className='flex flex-col justify-center dark:text-[var(--text-primary)] text-[#1A202C] px-4 gap-2'>
