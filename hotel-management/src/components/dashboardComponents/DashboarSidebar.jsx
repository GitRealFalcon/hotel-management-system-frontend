...
const DashboarSidebar = () => {
    ...
    return (
        <div className={`first:w-[10%] second:w-[30%] third:w-[40%] forth:w-[50%] fifth:w-[60%] sixth:w-[70%] h-screen dark:bg-[var(--bg-secondry)] bg-[#FFFFFF]  z-10 ${isOpen ? 'translate-x-0' : '-translate-x-full'} transform transition-all duration-300 first:translate-x-0 fixed first:sticky top-0 p-4`}>
